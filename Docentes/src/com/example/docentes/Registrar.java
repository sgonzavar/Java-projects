	...
	public void EnviarOnClik(View view) {
		Thread nt = new Thread() {
			...
			public void run() {
				...
				try {
					final String res;
					final EditText ape = (EditText) findViewById(R.id.txtApe);
					final EditText nom = (EditText) findViewById(R.id.txtNom);
					
						res = enviarGet(apellidos.getText().toString(), nombres.getText().toString(), telefono.getText().toString(), email.getText().toString(), ciudad.getText().toString(), curso.getText().toString());
					runOnUiThread(new Runnable() {
						@Override
						public void run() {
							Toast.makeText(Registrar.this, "SE HA REGISTRADO A: "+ape.getText().toString()+" "+nom.getText().toString(),
...
/*
	public String enviarPost(String apellidos, String nombres, String telefono, String email, String ciudad, String curso) {

		HttpClient httpClient = new DefaultHttpClient();
		HttpContext localContext = new BasicHttpContext();
		HttpPost httpPost = new HttpPost(
				"http://tuipaqui/PutData/PutData.php");
	...
	public String enviarGet(String apellidos, String nombres, String telefono, String email, String ciudad, String curso) {
		HttpClient httpClient = new DefaultHttpClient();
		HttpContext localContext = new BasicHttpContext();
		HttpResponse response = null;
		String parametros = "?apellidos=" + apellidos + "&nombres=" + nombres
				+ "&telefono=" + telefono + "&email=" + email + "&ciudad=" + ciudad + "&curso=" + curso;

		HttpGet httpget = new HttpGet(
				"http://tuipaqui/PutData/PutData.php" + parametros);
		try {
