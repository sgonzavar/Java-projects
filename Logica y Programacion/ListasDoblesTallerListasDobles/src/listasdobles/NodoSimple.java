...
public class NodoSimple {
    ...
    private Object dato;
    private NodoSimple cabeza, siguiente, Fin, q, p, z;
    ...
    public void insertarAntes(Object info, Object dtoRef) {
        Object d = info, Ref = dtoRef;
        if (VerificarLista() == false) {
            if (Buscar(Ref) == true) {
                if (q == cabeza) {
                    insertarcabeza(d);
                } else {
                    p.siguiente.siguiente = new NodoSimple(d, p.siguiente);
                }
            }
        }
    }

    public void insertarDespues(Object info, Object dtoRef) {
        Object d = info, Ref = dtoRef;
        if (VerificarLista() == false) {
            if (Buscar(Ref) == true) {
                q.siguiente = new NodoSimple(d, q.siguiente);
            }
        }
    }
